...
export default async function KinhRamPage() {
  const products = await getProductsByCategory('Kính râm');
    ...
    <main style={{ minHeight: '100vh', backgroundColor: '#fff' }}>
      ...
      <div style={{ padding: '140px 5% 80px', maxWidth: '1500px', margin: '0 auto' }}>
        <p style={{ fontSize: '0.9rem', color: '#aaa', marginBottom: '30px' }}>
          <Link href="/" style={{ color: '#aaa', textDecoration: 'none' }}>Trang chủ</Link> / <span style={{ color: 'var(--primary)' }}>Kính râm</span>
        </p>
